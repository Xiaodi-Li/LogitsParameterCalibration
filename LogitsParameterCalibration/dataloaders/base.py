...
def GlueData(args, task, task_name, tokenizer, evaluate=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        examples = (
            processor.get_dev_examples(args.data_dir + '/' + str(task_name)) if evaluate else processor.get_train_examples(args.data_dir + '/' + str(task_name))
        )
